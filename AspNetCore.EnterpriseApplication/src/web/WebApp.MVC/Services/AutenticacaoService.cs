...
namespace WebApp.MVC.Services
{
    public class AutenticacaoService : IAutenticacaoService
    {
        ...
        {
            var content = new StringContent(JsonSerializer.Serialize(usuarioRegistro),
                                                Encoding.UTF8,
                                                "application/json");

            var response = await _httpClient.PostAsync("https://localhost:44301/api/identidade/nova-conta", content);
